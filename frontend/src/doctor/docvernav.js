<<<<<<< HEAD:project/frontend/src/doctor/docvernav.js
...
export default function Docvernav() {
  ...
  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z"/>
                ...
                <li className="docele" style={{  borderRight:  activeLink === "/doctorsetting" ? "5px solid snow" : "none", }}>
                    ...
                    <Link to="/Doctorchat" id="doctor_settings" onClick={() => handleActiveLink("/doctorsetting")}>Chat</Link>
                </li>
                <li className="docele" style={{  borderRight:  activeLink === "/doctorsetting" ? "5px solid snow" : "none", }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16">
                        <path d="M8 4.754a3.246 3.246 0 1 0 0 6.492 3.246 3.246 0 0 0 0-6.492M5.754 8a2.246 2.246 0 1 1 4.492 0 2.246 2.246 0 0 1-4.492 0"/>
...
>>>>>>> ef9dbd2d95e994bb90753e4ae8d186708e2e860f:frontend/src/doctor/docvernav.js
}