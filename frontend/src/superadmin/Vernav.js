    ...
    <div className="vernav">
      ...
      <div className="navbar">
        <ul style={{paddingLeft:"0"}}>
          ...
          <li className="ele" style={{  borderRight:  activeLink === "/appointments" ? "5px solid snow" : "none" }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
            ...
            <Link to='/appointments' onClick={() => handleActiveLink("/appointments")}>appointments</Link>
          </li>
